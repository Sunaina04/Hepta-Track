        ...
        <Dialog visible={visible} style={{
          ...
          <div>
            ...
            <div>
              ...
              <div className="mt-3 card flex justify-content-center border">
                <InputText value={userName} placeholder="Street/Building" onChange={(e) => setUserName(e.target.value)}
                  style={{
                    width: '230px',
                    height: '32px',
                    border: '1px solid #D5E1EA',
              ...
              <div className=" ml-[260px] mt-[-34px] flex justify-content-center border">
                <InputText value={userName} placeholder="Apt/Suite" onChange={(e) => setUserName(e.target.value)}
                  style={{
                    width: '230px',
                    height: '32px',
                    border: '1px solid #D5E1EA',
              ...
              <div className=" mt-4 card flex justify-content-center border">
                <InputText value={phone} placeholder="Zip Code" onChange={(e) => setPhone(e.target.value)}
                  style={{
                    width: '230px',
                    height: '32px',
                    border: '1px solid #D5E1EA',
